...
import 'package:cows_bulls_game/ui/common/keyboard/keyboard_button_widgets/input_digit_widgets/digit_cell_widget.dart';
import 'package:cows_bulls_game/ui/common/keyboard/keyboard_button_widgets/input_digit_widgets/locked_digit_cell_widget.dart';
import 'package:cows_bulls_game/ui/common/keyboard/keyboard_button_widgets/input_digit_widgets/marked_digit_cell_widget.dart';
...
class InputNumbersRowWidget extends StatelessWidget {
  ...
  const InputNumbersRowWidget(this.rowLabels, this._isDigitMarked,
      this._isDigitLocked, this._inputDigit, this._inputMode);
        ...
        return GestureDetector(
            ...
            child: Padding(
                padding: (i == rowLabels.length - 1)
                    ? EdgeInsets.zero
                    : EdgeInsets.only(
                        right: dimensions.width * enterDigitRowSpaceCoeff),
                child: _buildCellWidget(
                    marked, locked, rowLabels[i], dimensions)));
      }));
    }
    return widgets;
  }
  ...
  Widget _buildCellWidget(
      bool marked, bool locked, String label, ScreenDimensions dimensions) {
    if (marked) {
